...
class _InlineTrendStrategy:
    direction = "LONG_ONLY"
    def __init__(self, filters: list[BaseFilter], hold_bars: int = 10, stop_distance_points: float = 3.0, name: str | None = None):
...
class TrendStrategyType(BaseStrategyType):
    ...
    default_hold_bars, default_stop_distance_points = 10, 3.0
    ...
    def get_active_refinement_grid_for_combo(self, classes: list[type]) -> dict[str, list]:
        grid = {"hold_bars": [5, 10, 15, 20], "stop_distance_points": [1.5, 2.0, 3.0, 4.0]}
