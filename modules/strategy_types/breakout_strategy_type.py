...
class BreakoutStrategyType(BaseStrategyType):
    ...
    def get_active_refinement_grid_for_combo(self, classes: list[type]) -> dict[str, list]:
        ...
        grid = {"hold_bars": [2, 4, 6, 8, 10], "stop_distance_points": [1.5, 2.0, 2.5, 3.0]}
        grid["min_avg_range"] = [0.6, 0.8, 1.0] if any(cls is CompressionFilter for cls in classes) else [0.0]
